                ...
                <div class="container">
                    ...
                    <script>
                        ...
                        form.addEventListener('submit', function(e) {
                            ...
                            localStorage.setItem("name-output", nameValue);
                            localStorage.setItem("email-output", emailValue);
                            localStorage.setItem("checkin-output", checkinValue);
                            localStorage.setItem("checkout-output", checkoutValue);
                            localStorage.setItem("select1-output", select1Value);
                            localStorage.setItem("select2-output", select2Value);
                            localStorage.setItem("select3-output", select3Value);
                            localStorage.setItem("message-output", messageValue);
    
                            window.location = "form-cetak.html";
