                    ...
                    <div class="row mb-3 mt-3">
                        <div class="col-4" hidden>
                            ...
                            <input type="date" class="form-control mb-1 @error('nama') is-invalid @enderror"
                                id="start_date" name="start_date" value="{{ Carbon\Carbon::now()->format('Y-m-d') }}" placeholder="">
                            @error('start_date')
                        ...
                        <div class="col-4">
                            ...
                            <input type="date" class="form-control mb-1 @error('start_date') is-invalid @enderror"
                                id="start_date" name="start_date" value="{{ old('start_date') }}" placeholder="">
                            @error('start_date')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-4">
                            <label for="end_date" class="form-label">Tanggal mulai</label>
